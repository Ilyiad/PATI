...
#    DEFAULT_DEVKEY      = '42'
    DEFAULT_SERVER_URL  = "http://172.16.0.86/testlink/lib/api/xmlrpc/v1/xmlrpc.php"
    DEFAULT_DEVKEY      = "345c8d2c3f94d60976bcd8745ba56f37"
    DEFAULT_DESCRIPTION = 'Python XML-RPC client for the TestLink API v%s' \
                            % VERSION
#    DEFAULT_DESCRIPTION = 'Python XML-RPC client for the TestLink API'
